		...
		<div class="header-two navbar navbar-default"><!--header-two-->
			<div class="container">
				...
				<div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s">
					<h1><a href="index.html">J4 <b>E-Shop</b><span class="tag">Gadgets and Clothing pool </span> </a></h1>
				</div>
		...
		<div class="container">
			<div class="footer-info">
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".5s">
					<h4 class="footer-logo"><a href="index.html">J4 <b>E-Shop</b> <span class="tag">Gadgets and Clothing pool </span> </a></h4>
